...
def _opensearch():
	...
	result_list = []
	for n in val_1:
		if hospital_name_box.get() in n:
			# 문자열이 포함된 병원명을 배열에 추가
			print("이건 인덱스넘버: ",val_1.index(n))
			result_index.append(val_1.index(n))

			#print("이건 찾은 병원명: ",val_1[val_1.index(n)])
			#result_list.append(val_1[val_1.index(n)])
...
#	print(result_list)
	...
	# 데이터 삽입 처리 2
	for n2 in result_index:
		search_result.insert('', 'end', text="*", value=[val_1[n2], val_2[n2], val_3[n2], val_4[n2], val_5[n2], val_6[n2], val_7[n2]])
...
def _enrollment():
	...
	if credentials.access_token_expired:
		msg.showwarning("경고", "시트 토큰이 만료되었습니다.")
		gs.login()
